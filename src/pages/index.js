...
export default function Home() {
  ...
  return (
    <div className="w-full max-w-none flex min-h-screen">
      <div className="bg-blue-600 w-full flex p-5 justify-center items-center">
        <form
          className="max-w-[400px] w-full flex flex-col border border-white md:px-5 md:py-12 px-4 py-6 bg-red-600 gap-6 text-white shadow-[0_35px_30px_-15px_rgba(240,240,240,0.3)]"
          ref={formRef}
